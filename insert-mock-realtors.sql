-- Insert 2 Mock Realtor Accounts
-- These will create realistic realtor profiles for testing

-- First, we need to create the auth users (this simulates what happens when users sign up)
-- Note: In a real scenario, these would be created through Supabase Auth signup
