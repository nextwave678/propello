-- SIMPLIFIED TEST DATA FOR RLS VERIFICATION
-- This creates leads for different agent phone numbers without requiring user profiles
-- Users will be created through the signup flow, then linked to these leads
...
-- Step 2: Add leads for a second test user (+1-555-999-9)
-- This user will be created through signup with email: michael.test@luxuryhomes.com
INSERT INTO public.leads (
    name,
    phone,
    email,
...
-- Step 3: Add leads for a third test user (+1-555-777-7)
-- This user will be created through signup with email: jessica.test@eliterealty.com
INSERT INTO public.leads (
    name,
    phone,
    email,
...
-- Step 4: Add some completed leads for testing analytics
INSERT INTO public.leads (
    name,
    phone,
    email,
